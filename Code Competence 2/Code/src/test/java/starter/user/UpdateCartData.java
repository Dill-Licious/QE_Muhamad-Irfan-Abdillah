...
public class UpdateCartData {
    ...
    public void receiveDataCartUpdated(){
        ...
        restAssuredThat(response -> response.body("products.productId", Matchers.equalTo(1)));
        restAssuredThat(response -> response.body("products.quantity", Matchers.equalTo(3)));
