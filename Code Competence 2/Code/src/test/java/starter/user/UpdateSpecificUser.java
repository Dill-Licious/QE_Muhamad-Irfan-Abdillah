...
public class UpdateSpecificUser {
    ...
    public void receiveUpdatedData(){
        ...
        restAssuredThat(response -> response.body("email", Matchers.equalTo("John@gmail.com")));
        ...
        restAssuredThat(response -> response.body("address.city", Matchers.equalTo("kilcoole")));
        ...
        restAssuredThat(response -> response.body("phone", Matchers.equalTo("1-570-236-7033")));
